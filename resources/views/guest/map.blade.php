        ...
        <div class="container">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Detail Lokasi {{ $warung->nama_warung }}</h3>
                    <a href="/rekomendasi" class="btn btn-default pull-right">Kembali</a>
                </div>
                <div class="box-body">
                    ...
                    <div id="map" class="w-100 mt-2" style="height: 500px; margin-top: 20px"></div>
                </div>
            </div>
        </div>
    </section>
