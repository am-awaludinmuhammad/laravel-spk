                    ...
                    <form class="form-horizontal" method="post" action="/fasilitas/update/{{ $fasilitas->kd_fasilitas }}">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="kd_fasilitas" value="{{ $fasilitas->kd_fasilitas }}" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="nama_fasilitas" value="{{ $fasilitas->nama_fasilitas }}" type="text" class="form-control">
                                </div>
                            </div>
                        </div>
